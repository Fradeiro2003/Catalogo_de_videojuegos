...
int main(){
    ...
    //Conversiones de fecha para generar límites al usurario en su respuesta
    ...
    do{
        ...
        cin >> opcion1;
        switch (opcion1) {
            //Agregar objeto de videojuego a vector
            case 1: {
            ...
            //Menú para modificar o desplegar datos
            case 2: {
                ...
                switch(opcion2){
                    ...
                    case 1:{
                        ...
                        //Se modifican los datos o se agregan crítcas
                    case 2:{
